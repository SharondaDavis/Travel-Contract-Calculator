      ...
      <div className="space-y-4">
          ...
          <label className="block text-sm font-medium text-gray-700 mb-1">
            ...
            {rentalPrices && (
              <span className="ml-2 text-xs text-green-500">
                Local averages: Studio ${(rentalPrices.studio_avg / 4).toFixed(0)}/wk, 
                1BR ${(rentalPrices.one_bedroom_avg / 4).toFixed(0)}/wk
              </span>
            )}
          </label>
          <input
        ...
        <div>
          <label className="block text-sm font-medium text-gray-700 mb-1">
            ...
            {rentalPrices && (
              <span className="ml-2 text-xs text-green-500">
                Local average: ${((rentalPrices.utilities_avg + rentalPrices.internet_avg) / 4).toFixed(0)}/wk
              </span>
            )}
          </label>
          <input
